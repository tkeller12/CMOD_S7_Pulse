...
HD_PWD='C:/Users/jkell/Repositories/CMOD_S7_Pulse/Software/Vivado/CMOD_S7_Pulse/CMOD_S7_Pulse.runs/clk_wiz_0_new_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_0_new.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_0_new.tcl
