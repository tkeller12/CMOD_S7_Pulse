...
HD_PWD='C:/Users/jkell/Repositories/CMOD_S7_Pulse/Software/Vivado/CMOD_S7_Pulse/CMOD_S7_Pulse.runs/CLOCK_SYNTH_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLOCK_SYNTH_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLOCK_SYNTH_clk_wiz_0_0.tcl
