...
HD_PWD='C:/Users/jkell/Repositories/CMOD_S7_Pulse/Software/Vivado/CMOD_S7_Pulse/CMOD_S7_Pulse.runs/clk_wiz_ext_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_ext.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_ext.tcl
