...
#                script (type 'clk_wiz_0_new.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/jkell/Repositories/CMOD_S7_Pulse/Software/Vivado/CMOD_S7_Pulse/CMOD_S7_Pulse.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
