...
#
# Script generated by Vivado on Tue Mar 17 18:29:05 -0400 2026
...
simulate()
{
  xsim clk_wiz_0_new -key {Behavioral:sim_top_1:Functional:clk_wiz_0_new} -tclbatch cmd.tcl -log simulate.log
}
