...
#
# Script generated by Vivado on Sat Apr 04 17:43:05 -0400 2026
...
simulate()
{
  xsim clk_wiz_0_new -key {Behavioral:sim_top_mem:Functional:clk_wiz_0_new} -tclbatch cmd.tcl -log simulate.log
}
